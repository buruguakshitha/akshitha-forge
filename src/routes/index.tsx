...
function Experience() {
  const roles = [
    ...
    },
    {
      ...
      time: "10-Week Virtual Internship",
      bullets: [
        "Completed a 10-week virtual internship focused on Generative AI.",
        "Gained practical experience with AI concepts, prompt engineering, and modern AI tools.",
        "Earned 22 skill badges through hands-on labs and guided learning paths.",
      ],
    },
  ];
  return (
